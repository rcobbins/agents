...
const agent = new CoderAgent(projectPath);
...
async function start() {
  try {
    console.log(`Starting Coder Agent for project ${projectId}`);
    ...
    console.log('Coder Agent started successfully');
    ...
    console.error('Failed to start Coder Agent:', error);
