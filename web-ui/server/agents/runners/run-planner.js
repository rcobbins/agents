...
/**
 * Runner script for Planner Agent
...
const agent = new PlannerAgent(projectPath);
...
async function start() {
  try {
    console.log(`Starting Planner Agent for project ${projectId}`);
    ...
    console.log('Planner Agent started successfully');
    ...
    console.error('Failed to start Planner Agent:', error);
